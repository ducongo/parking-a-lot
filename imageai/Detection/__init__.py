...
class VideoObjectDetection:
    ...
    def detectObjectsFromVideo(self, file_stream= None, input_file_path="", camera_input=None, output_file_path="", frames_per_second=20,
        ...
        if (input_file_path == "" and camera_input == None and file_stream== None):
            raise ValueError(
